...
/** @class Subnet.
 *
 *  SubNet class use to handle all information needed in creating a transition,
 * which is corresponding to an event in dcr graph
 */
class SubNet {
 public:
  /** Constructor. Initializes id and name of transition */
  SubNet(const std::string& _name, const std::string& _id)
      : name(_name), id(_id) {}
...
/** @class Translator
 *
 * Translator class use to handle all information needed in translating a dcr
 * class obj into helena code.
 */
